...
namespace CurioClerk.Localization
{
    public sealed class Localizer
    {
        ...
        {
            ["title"] = "CURIO CLERK",
            ["subtitle"] = "NIGHT LOST-PROPERTY OFFICE",
            ["start"] = "Start Shift",
            ["daily"] = "Daily File",
            ...
            ["hold_wait_for_seal"] = "FILE THIS FIRST",
            ["hold_blocked_by_stamp"] = "The curio that would come next needs a stamped desk. File the current curio first.",
            ["next"] = "NEXT",
            ["rules"] = "TONIGHT'S RULES",
            ["fallback"] = "Otherwise → {0}",
            ...
            ["incident_continue"] = "Continue case · {0}/{1}",
            ["incident_stage"] = "Task {0}/{1}",
            ...
            ["incident_first_investigation"] = "Start your first night",
            ["incident_in_progress"] = "Investigation in progress",
            ["incident_first_clue"] = "FIRST CLUE",
            ["incident_waiting"] = "Next shift in preparation",
            ["incident_resolved"] = "CASE RESOLVED",
            ["incident_replay_case"] = "Replay Case",
            ["incident_return_board"] = "Back to the office",
            ["free_shift"] = "Sorting practice",
            ["senior_clerk"] = "Senior",
            ["narrative_continue"] = "Continue",
            ["retry_stage"] = "Retry This Shift",
            ["next_stage"] = "Next task",
        ...
        private static readonly IReadOnlyDictionary<string, string> Korean = new Dictionary<string, string>
        {
            ...
            ["hold_wait_for_seal"] = "현재 물건 먼저",
            ["hold_blocked_by_stamp"] = "보류로 바꾸면 이미 찍힌 목적지의 물건이 나옵니다. 현재 물건을 먼저 처리하세요.",
            ["next"] = "다음",
            ["rules"] = "오늘 밤의 규칙",
            ["fallback"] = "그 외 → {0}",
            ["correct"] = "깔끔하게 처리했습니다.",
            ...
            ["incident_continue"] = "업무 이어하기 · {0}/{1}",
            ["incident_stage"] = "작업 {0}/{1}",
            ["incident_complete"] = "첫 사건 해결",
            ["incident_replay"] = "사건 다시보기",
            ["incident_next_teaser"] = "다음 사건 · 실내에서 비를 맞은 우산",
            ["incident_first_investigation"] = "첫 출근",
            ["incident_in_progress"] = "조사 진행 중",
            ["incident_first_clue"] = "첫 단서",
            ["incident_waiting"] = "다음 교대 준비 중",
            ["incident_resolved"] = "사건 해결",
            ["incident_replay_case"] = "사건 다시보기",
            ["incident_return_board"] = "보관소로 돌아가기",
            ["free_shift"] = "분류 연습",
            ["senior_clerk"] = "선임",
