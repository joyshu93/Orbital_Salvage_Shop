...
namespace CurioClerk.Localization
{
    public sealed class Localizer
    {
        private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
        {
            ...
            ["language"] = "Language",
            ["privacy"] = "Privacy",
            ["analytics_on"] = "Anonymous analytics: ON",
            ["analytics_off"] = "Anonymous analytics: OFF",
            ["crash_on"] = "Crash reports: ON",
            ["crash_off"] = "Crash reports: OFF",
        ...
        private static readonly IReadOnlyDictionary<string, string> Korean = new Dictionary<string, string>
        {
            ...
            ["language"] = "언어",
            ["privacy"] = "개인정보",
            ["analytics_on"] = "익명 분석: 켜짐",
            ["analytics_off"] = "익명 분석: 꺼짐",
            ["crash_on"] = "충돌 보고: 켜짐",
            ["crash_off"] = "충돌 보고: 꺼짐",
