...
| Google Mobile Ads Unity plugin | `com.google.ads.mobile` 11.3.0 in `Packages/manifest.json`; official release: https://github.com/googleads/googleads-mobile-unity/releases/tag/v11.3.0; resolved via Google OpenUPM. | Apache License 2.0; retain and review the package license from the human-resolved package cache before the RC notice audit. | **Pinned; Unity resolution pending.** Use only this UPM installation, and do not import an Asset-package copy. |
...
| Firebase App (Core) for Unity | `GooglePackages/com.google.firebase.app-13.15.0.tgz`; official archive: https://dl.google.com/games/registry/unity/com.google.firebase.app/com.google.firebase.app-13.15.0.tgz; SHA-256: `78467DB3E3EC706FC3F44D09C659BA51B2EEC770E85577254FFEB5EA51FE6090`. | Apache License 2.0 in archive path `package/LICENSE.md`; review native transitive notices after Unity/EDM resolution. | **Pinned and archive-verified.** Embedded `package/package.json` declares `com.google.firebase.app` 13.15.0; Unity resolution remains pending. |
| Google Analytics for Firebase (Unity) | `GooglePackages/com.google.firebase.analytics-13.15.0.tgz`; official archive: https://dl.google.com/games/registry/unity/com.google.firebase.analytics/com.google.firebase.analytics-13.15.0.tgz; SHA-256: `0EA3CB1C5B8976FD3B579508A7CDF26AB591348980B281D465D44693F1BFE20A`. | Apache License 2.0 in archive path `package/LICENSE.md`; Analytics collection is disabled by default in `Assets/Plugins/Android/AndroidManifest.xml`. | **Pinned and archive-verified.** Embedded `package/package.json` declares `com.google.firebase.analytics` 13.15.0; Unity resolution remains pending. |
| Firebase Crashlytics for Unity | `GooglePackages/com.google.firebase.crashlytics-13.15.0.tgz`; official archive: https://dl.google.com/games/registry/unity/com.google.firebase.crashlytics/com.google.firebase.crashlytics-13.15.0.tgz; SHA-256: `75EA908481EABCB3AE004ED04179DB5F4AEFC5668131E27049EA0FF46A206232`. | Apache License 2.0 in archive path `package/LICENSE.md`; Crashlytics collection is disabled by default in `Assets/Plugins/Android/AndroidManifest.xml`. | **Pinned and archive-verified.** Embedded `package/package.json` declares `com.google.firebase.crashlytics` 13.15.0; Unity resolution remains pending. |
...
- Firebase runtime adapter integration and consent-toggle wiring;
